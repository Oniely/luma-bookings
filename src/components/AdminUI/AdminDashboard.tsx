...
const AdminOptions = [
	{
		...
		description: "Update your password and secure the Admin account",
		path: "/login-security",
	},
...

	{
		icon: Bed,
		title: "Manage Hotels",
		description: "Manage all the hotels and details",
		path: "/manage-hotels",
	},

	{
		...
		description: "Manage Payments Options, Packages, and Events",
		path: "/other-settings",
	},
];
