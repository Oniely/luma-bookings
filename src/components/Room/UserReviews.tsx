...
import { Star, House, HandHelping, HeartHandshake, Brush, PiggyBank, VolumeX, Expand } from 'lucide-react';
...
const styles = {
  ...
  reviewsList: {
    ...
    scrollSnapType: "x mandatory", // Enables smooth snap scrolling
    paddingBottom: "10px", // For better spacing
  },
  review: {
    display: "inline-block", // Ensures items stay in one line
    minWidth: "300px", // Ensures each review has space
    maxWidth: "300px", // Keeps uniform width
    padding: "15px",
    backgroundColor: "transparent",
...
const RatingsSummary = ({ overallRating }: { overallRating: number }) => {
  return (
    <div style={styles.summary}>
      <div style={styles.overallRating}><Star /> <strong>{overallRating}</strong> <span>Overall rating</span></div>
    </div>
  );
};
